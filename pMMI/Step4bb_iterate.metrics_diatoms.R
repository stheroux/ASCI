...
# cd ~/Documents/R/ASCI/pMMI/diatoms
...
win.metrics<-c(  "prop.spp.Trophic.E",
                 "prop.spp.Salinity.BF",
                 "prop.spp.BCG12",
                 "prop.spp.OxyReq.DO_100orDO_75_raw",
...
win.metrics.raw<-c("prop.spp.Trophic.E_raw",
                   "prop.spp.Salinity.BF_raw",
                   "prop.spp.BCG12_raw",
                   "prop.spp.OxyReq.DO_100orDO_75_raw",
                   NULL ) 
